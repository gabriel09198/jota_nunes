    ...
    subtitulos: [
        ...
        campos: [
          {
            name: "sala_piso",
            label: "Piso",
            options: ["Porcelanato ou laminado"],
          },
          {
            name: "sala_parede",
            label: "Parede",
          ...
          },
          {
            name: "sala_rodape",
            label: "Rodapé",
            options: ["Porcelanato ou Laminado, h= 5cm"],
          },
          {
            name: "sala_soleira",
            label: "Soleira",
            options: ["Mármore ou granito."],
          },
          { name: "sala_peitoril", label: "Peitoril", options: ["Metálico"] },
          {
            name: "sala_esquadria",
            label: "Esquadria",
            options: ["Alumínio pintado de branco"],
          },
          { name: "sala_vidro", label: "Vidro", options: ["Liso incolor."] },
          {
            name: "sala_porta",
            label: "Porta",
            options: ["Porta semi–ôca comum pintada c/ esmalte sintético."],
          },
          {
            name: "sala_ferragem",
            label: "Ferragem",
            options: ["Acabamento cromado."],
          },
          {
            name: "sala_inst_eletrica",
            label: "Inst. Elétrica",
            options: [
          ...
          {
            name: "sala_inst_comunic",
            label: "Inst. Comunic.",
            options: ["Pontos secos de comunicação e de antena de TV."],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        campos: [
          ...
          {
            name: "quarto_peitoril",
            label: "Peitoril",
            options: ["Metálico."],
          },
          {
            name: "quarto_esquadria",
            label: "Esquadria",
            options: ["Alumínio pintado de branco."],
          },
          ...
          {
            name: "quarto_ferragem",
            label: "Ferragem",
            options: ["Acabamento cromado."],
          },
          {
            name: "quarto_inst_eletrica",
            label: "Inst. Elétrica",
            options: [
              "Pontos de luz no teto, tomadas de corrente e interruptores.",
            ],
          ...
          },
          {
            ...
            options: ["Infraestrutura para high wall com condensadora axial."],
          },
        ],
      },
      {
        ...
        campos: [
          { name: "san_piso", label: "Piso", options: ["Cerâmica."] },
          {
            name: "san_parede",
            label: "Parede",
            options: ["Cerâmica até o teto."],
          },
          { name: "san_teto", label: "Teto", options: ["Forro de gesso."] },
          {
            name: "san_filete",
            label: "Filete",
            options: ["Mármore ou granito L=3,5cm."],
          },
          {
            name: "san_cordao_box",
            label: "Cordão de Box",
          ...
          },
          {
            name: "san_bancada",
            label: "Bancada",
            options: ["Em mármore ou granito com cuba em louça cor branca"],
          },
          {
            name: "san_porta",
            label: "Porta",
            options: ["Porta semi-ôca comum pintura c/ esmalte sintético."],
          },
          ...
          },
          {
            name: "san_vidro",
            label: "Vidro",
            options: ["Pontilhado Incolor."],
          },
          {
            name: "san_metal",
            label: "Metal Sanitário",
            options: [
          ...
          },
          {
            name: "san_loucas",
            label: "Louças",
            options: ["Vaso Sanitário com Caixa Acoplada em louça cor branca."],
          },
          {
            name: "san_inst_eletrica",
            label: "Inst. Elétrica",
            options: [
          ...
          {
            name: "san_inst_hidraulica",
            label: "Inst. Hidráulica",
            options: [
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            name: "coz_metais",
            label: "Metais",
            options: ["Torneiras e registro de gaveta com acabamento cromado."],
          },
          {
            name: "coz_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto, tomadas de corrente e interruptores.",
            ],
          },
          {
            name: "coz_inst_hidraulica",
            label: "Inst. Hidráulica",
            options: ["Rede de água fria em PEX e esgoto em PVC"],
          },
          {
            name: "coz_inst_comunic",
            label: "Inst. Comunicação",
            options: ["Tubulação seca."],
          },
        ],
      },
      {
        ...
        campos: [
          {
            name: "areaTec_piso",
            label: "Piso",
            options: ["Em concreto desempolado."],
          },
          {
            name: "areaTec_parede",
            label: "Parede",
            options: ["Textura acrílica."],
          },
          {
            name: "areaTec_teto",
            label: "Teto",
            options: ["Pintura ou textura acrílica."],
          },
          {
            name: "areaTec_gradil",
            label: "Gradil",
            options: ["Em perfil metálico pintado de branco."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: "Teto",
            options: [
              "Pintura PVA látex branco sobre gesso ou massa de regularização PVA ou Forro de gesso.",
            ],
          },
          {
            name: "var_rodape",
          ...
          },
          {
            name: "var_porta",
            label: "Porta",
            options: ["Alumínio pintado de branco com vidro liso."],
          },
          {
            name: "var_inst_eletrica",
            label: "Inst. Elétrica",
            options: ["Ponto de luz no teto."],
          },
          {
            name: "var_guardacorpo",
            label: "Guarda Corpo",
            options: ["Em perfil metálico pintado de branco."],
          },
        ],
    ...
    subtitulos: [
      {
        ...
        campos: [
          ...
          {
            name: "guarita_parede_externa",
            label: "Parede Externa",
            options: ["Acabamento em textura acrílica."],
          },
          {
            name: "guarita_rodape",
            label: "Rodapé",
            options: ["Cerâmica, h=5 cm."],
          },
          {
            name: "guarita_soleira",
            label: "Soleira",
            options: ["Mármore ou granito."],
          },
          {
            name: "guarita_peitoril",
            label: "Peitoril",
            options: ["Metálico ou granito."],
          },
          {
            name: "guarita_ferragens",
            label: "Ferragens",
            options: ["Acabamento cromado."],
          },
          {
            name: "guarita_porta_ext",
            label: "Porta externa",
            options: ["Alumínio pintado na cor branca com vidro liso."],
          },
          {
            name: "guarita_esquadrias",
            label: "Esquadrias",
            options: ["Alumínio pintado de branco."],
          },
          { name: "guarita_vidro", label: "Vidro", options: ["Liso incolor."] },
          {
            name: "guarita_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária, tomada de corrente e interruptor na cor branco.",
            ],
          },
          {
            name: "guarita_inst_comunic",
            label: "Inst. Comunic.",
            options: ["Tubulação seca."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          { name: "gour_cuba", label: "Cuba", options: ["Inox."] },
          {
            name: "gour_metais",
            label: "Metais",
            options: ["Torneira para pia com acabamento cromado."],
          },
          {
            name: "gour_tampo_balcao",
            label: "Tampo do balcão",
            options: ["Mármore ou granito."],
          },
          {
            name: "gour_churrasqueira",
            label: "Churrasqueira",
            options: ["Pré-moldada ou alvenaria."],
          },
          {
            name: "gour_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária, tomada de corrente e interruptor na cor branco.",
            ],
          ...
          {
            name: "gour_inst_hidraulica",
            label: "Inst. Hidráulica",
            options: ["Engate, sifão, rede de água fria e esgoto em PVC."],
          },
          {
            name: "gour_inst_comunic",
            label: "Inst. Comunic.",
            options: ["Tubulação seca."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            name: "quiosque_rodape",
            label: "Rodapé",
            options: ["Porcelanato, h=5 cm."],
          },
          {
            name: "quiosque_tabeira",
            label: "Tabeira",
            options: ["Mármore ou granito."],
          },
          {
            name: "quiosque_bancada",
            label: "Bancada",
            options: ["Mármore ou granito."],
          },
          { name: "quiosque_cuba", label: "Cuba", options: ["Inox."] },
          {
            name: "quiosque_metais",
            label: "Metais",
            options: ["Torneira para pia com acabamento cromado."],
          },
          {
          ...
          {
            name: "quiosque_churrasqueira",
            label: "Churrasqueira",
            options: ["Pré-moldada ou alvenaria."],
          },
          {
            name: "quiosque_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária, tomada de corrente e interruptor na cor branco.",
            ],
          ...
          {
            name: "quiosque_inst_hidraulica",
            label: "Inst. Hidráulica",
            options: ["Engate, sifão, rede de água fria e esgoto em PVC."],
          },
          {
            name: "quiosque_inst_comunic",
            label: "Inst. Comunic.",
            options: ["Tubulação seca."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            name: "copa_inst_hidraulica",
            label: "Inst. Hidráulica",
            options: ["Engate, sifão, rede de água fria e esgoto em PVC."],
          },
          {
            name: "copa_inst_comunic",
            label: "Inst. Comunic.",
            options: ["Tubulação seca."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            name: "petplay_fechamento",
            label: "Fechamento",
            options: ["Tela alambrado ou tela de proteção."],
          },
          {
            name: "petplay_equip",
            label: "Equipamentos",
            options: ["A serem definidos"],
          },
        ],
      },
      {
        ...
        campos: [
          {
            name: "parque_piso",
            label: "Piso",
            options: ["Intertravado emborrachado ou grama."],
          },
          {
            name: "parque_brinq",
            label: "Brinquedos",
      ...
      },
      {
        ...
        campos: [
          ...
          {
            name: "brinq_ferragens",
            label: "Ferragens",
            options: ["Acabamento cromado."],
          },
          {
            name: "brinq_esquadria",
            label: "Esquadria",
            options: ["Alumínio pintado de branco."],
          },
          { name: "brinq_vidro", label: "Vidro", options: ["Liso incolor."] },
          {
            name: "brinq_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária, tomada de corrente e interruptor na cor branco.",
            ],
      ...
      },
      {
        ...
        campos: [
          ...
          {
            name: "sf_tampo_balcao",
            label: "Tampo do Balcão",
            options: ["Mármore ou granito."],
          },
          {
            name: "sf_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária, tomada de corrente e interruptor na cor branco.",
            ],
          ...
          {
            name: "sf_inst_hidraulica",
            label: "Inst. Hidráulica",
            options: ["Engate, sifão, rede de água fria e esgoto em PVC."],
          },
          {
            name: "sf_inst_comunic",
            label: "Inst. Comunic.",
            options: ["Tubulação seca."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          },
          {
            name: "bicic_parede",
            label: "Parede",
            options: ["Pintura acrílica ou textura acrílica."],
          },
          {
            name: "bicic_teto",
            label: "Teto",
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: "Teto",
            options: [
              "Pintura PVA látex branco sobre gesso ou massa de regularização PVA ou Forro em gesso.",
            ],
          },
          {
            name: "acad_rodape",
            label: "Rodapé",
            options: ["Vinílico, mármore, granito ou madeira, h=5cm."],
          },
          {
            name: "acad_soleira",
            label: "Soleira",
      ...
      },
      {
        ...
        campos: [
          { name: "qe_piso", label: "Piso", options: ["Concreto."] },
          {
            name: "qe_parede",
            label: "Parede",
            options: ["Fechamento em tela de nylon ou alambrado."],
          },
          {
            name: "qe_equip",
            label: "Equipamentos",
      ...
      },
      {
        ...
        campos: [
          { name: "qa_piso", label: "Piso", options: ["Areia."] },
          {
            name: "qa_parede",
            label: "Parede",
            options: ["Alambrado, rede de proteção em nylon ou mureta."],
          },
          {
            name: "qa_equip",
            label: "Equipamentos",
        ...
        campos: [
          {
            name: "pis_pisc_piso",
            label: "Piso (Piscina)",
            options: ["Pastilha cerâmica."],
          },
          {
            name: "pis_pisc_parede",
            label: "Parede (Piscina)",
            options: ["Pastilha cerâmica."],
          },
          {
            name: "pis_deck",
            label: "Piso Deck",
            options: [
              "Porcelanato Incesa, Lef, Incefra, Portobello ou Cecafi, ou pedra natural.",
            ],
          },
          {
            name: "pis_borda",
          ...
          },
          {
            ...
            label: "Equipamentos",
            options: [
              "Bomba e filtro da Jacuzzi, Mark Peerles ou similar, e dispositivos em aço inox ou PVC.",
            ],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            name: "ger_parede_interna",
            label: "Parede interna",
            options: ["Pintura PVA látex."],
          },
          {
            name: "ger_parede_externa",
            label: "Parede externa",
            options: ["Textura acrílica."],
          },
          ...
          { name: "ger_cobogo", label: "Cobogó", options: ["Em concreto."] },
          {
            name: "ger_portao",
            label: "Portão",
            options: ["Metálico pintado de branco."],
          },
          {
            name: "ger_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária e interruptor na cor branco.",
            ],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            name: "cl_parede_interna",
            label: "Parede interna",
            options: ["Cerâmica."],
          },
          {
            name: "cl_parede_externa",
            label: "Parede externa",
            options: ["Textura acrílica."],
          },
          {
            name: "cl_teto",
            label: "Teto",
            options: ["Pintura PVA látex branco."],
          },
          {
            name: "cl_soleira",
            label: "Soleira",
          ...
          {
            name: "cl_inst_hidraulico",
            label: "Inst. Hidráulico",
            options: ["Torneira em PVC rígido."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          },
          {
            name: "vest_ferragens",
            label: "Ferragens",
            options: ["Com acabamento cromado."],
          },
          {
            name: "vest_inst_eletricas",
            label: "Inst. Elétricas",
            options: [
              "Ponto de luz no teto com luminária e interruptor na cor branco.",
            ],
        ...
        campos: [
          {
            ...
            options: [
              "Bloco cerâmico rebocado e pintado ou bloco de concreto aparente.",
            ],
          },
          {
            name: "muro_acab_ext",
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            name: "hall_rodape",
            label: "Rodapé",
            options: ["Porcelanato, h=5cm."],
          },
          {
            name: "hall_inst_eletricas",
            label: "Inst. Elétricas",
            options: ["Ponto de luz no teto com luminária."],
          },
        ],
      },
      {
        ...
        campos: [
          {
            name: "ig_rede_eletrica",
            label: "Rede elétrica",
            options: ["Rede aérea ou subterrânea."],
          },
          {
            name: "ig_rede_comunic",
            label: "Rede de comunicação",
            options: [
              "Rede subterrânea ou aérea com tubulação seca e shafts ao longo dos pavimentos.",
            ],
          },
          {
            name: "ig_iluminacao_ruas",
            label: "Iluminação das ruas",
            options: [
          ...
          {
            name: "ig_drenagem",
            label: "Drenag./pluviais",
            options: ["Através de caixas com lançamento em rede existente."],
          },
          {
            name: "ig_esgoto",
            label: "Esgot. Sanitário",
            options: [
      ...
      },
      {
        ...
        campos: [
          {
            name: "vias_pavimentacao",
            label: "Pavimentação",
            options: [
              "Piso intertravado de concreto ou paralelepípedo sobre colchão de areia.",
            ],
          },
        ],
      },
        ...
        campos: [
          {
            ...
            label: "Jardins",
            options: [
              "Grama e alguns arbustos em locais definidos no projeto.",
            ],
          },
        ],
      },
        ...
        campos: [
          {
            name: "passeio_descr",
            label: "Passeio",
            options: ["Em concreto com junta seca."],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            name: "portao_inst_eletrica",
            label: "Inst. Elétrica",
            options: [
              "Fechadura elétrica no portão para pedestres, e motor para acionamento do portão para veículos.",
            ],
          },
        ],
      },
...
export default function CadastroImovel() {
  ...
  const filteredSecoes = ALL_SECOES.map((secao) => ({
    ...secao,
    subtitulos: secao.subtitulos.filter((sub) =>
      selectedRoomNames.includes(sub.nome)
    ),
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-xl text-gray-500">
          Carregando ambientes selecionados...
        </p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-10">
      ...
      >
        ...
        <h1 className="text-4xl font-extrabold text-center text-red-700 mb-4 tracking-tight">
          Personalização da Obra (Passo 3)
        </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
          ...
          {filteredSecoes.length === 0 && (
            <p className="text-center text-xl text-red-500 mt-10">
              Nenhum ambiente foi selecionado no Passo 2. Por favor, volte e
